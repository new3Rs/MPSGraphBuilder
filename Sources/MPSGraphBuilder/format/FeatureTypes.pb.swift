...
extension CoreML_Specification_ImageFeatureType.ColorSpace: CaseIterable {
  ...
  static let allCases: [CoreML_Specification_ImageFeatureType.ColorSpace] = [
    .invalidColorSpace,
    .grayscale,
    .rgb,
    .bgr,
...
extension CoreML_Specification_ArrayFeatureType.ArrayDataType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [CoreML_Specification_ArrayFeatureType.ArrayDataType] = [
...
extension CoreML_Specification_Int64FeatureType: @unchecked Sendable {}
extension CoreML_Specification_DoubleFeatureType: @unchecked Sendable {}
extension CoreML_Specification_StringFeatureType: @unchecked Sendable {}
extension CoreML_Specification_SizeRange: @unchecked Sendable {}
extension CoreML_Specification_ImageFeatureType: @unchecked Sendable {}
extension CoreML_Specification_ImageFeatureType.OneOf_SizeFlexibility: @unchecked Sendable {}
extension CoreML_Specification_ImageFeatureType.ColorSpace: @unchecked Sendable {}
extension CoreML_Specification_ImageFeatureType.ImageSize: @unchecked Sendable {}
extension CoreML_Specification_ImageFeatureType.EnumeratedImageSizes: @unchecked Sendable {}
extension CoreML_Specification_ImageFeatureType.ImageSizeRange: @unchecked Sendable {}
extension CoreML_Specification_ArrayFeatureType: @unchecked Sendable {}
extension CoreML_Specification_ArrayFeatureType.OneOf_ShapeFlexibility: @unchecked Sendable {}
extension CoreML_Specification_ArrayFeatureType.OneOf_DefaultOptionalValue: @unchecked Sendable {}
extension CoreML_Specification_ArrayFeatureType.ArrayDataType: @unchecked Sendable {}
extension CoreML_Specification_ArrayFeatureType.Shape: @unchecked Sendable {}
extension CoreML_Specification_ArrayFeatureType.EnumeratedShapes: @unchecked Sendable {}
extension CoreML_Specification_ArrayFeatureType.ShapeRange: @unchecked Sendable {}
extension CoreML_Specification_DictionaryFeatureType: @unchecked Sendable {}
extension CoreML_Specification_DictionaryFeatureType.OneOf_KeyType: @unchecked Sendable {}
extension CoreML_Specification_SequenceFeatureType: @unchecked Sendable {}
extension CoreML_Specification_SequenceFeatureType.OneOf_Type: @unchecked Sendable {}
extension CoreML_Specification_FeatureType: @unchecked Sendable {}
extension CoreML_Specification_FeatureType.OneOf_Type: @unchecked Sendable {}
