...
extension CoreML_Specification_OneHotEncoder.HandleUnknown: CaseIterable {
  ...
  static let allCases: [CoreML_Specification_OneHotEncoder.HandleUnknown] = [
    .errorOnUnknown,
    .ignoreUnknown,
  ]
}
...
extension CoreML_Specification_OneHotEncoder: @unchecked Sendable {}
extension CoreML_Specification_OneHotEncoder.OneOf_CategoryType: @unchecked Sendable {}
extension CoreML_Specification_OneHotEncoder.HandleUnknown: @unchecked Sendable {}
