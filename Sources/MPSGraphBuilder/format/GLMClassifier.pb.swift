...
extension CoreML_Specification_GLMClassifier.PostEvaluationTransform: CaseIterable {
  ...
  static let allCases: [CoreML_Specification_GLMClassifier.PostEvaluationTransform] = [
    .logit,
    .probit,
  ]
}
...
extension CoreML_Specification_GLMClassifier.ClassEncoding: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [CoreML_Specification_GLMClassifier.ClassEncoding] = [
    .referenceClass,
    .oneVsRest,
  ]
}
...
extension CoreML_Specification_GLMClassifier: @unchecked Sendable {}
extension CoreML_Specification_GLMClassifier.OneOf_ClassLabels: @unchecked Sendable {}
extension CoreML_Specification_GLMClassifier.PostEvaluationTransform: @unchecked Sendable {}
extension CoreML_Specification_GLMClassifier.ClassEncoding: @unchecked Sendable {}
extension CoreML_Specification_GLMClassifier.DoubleArray: @unchecked Sendable {}
