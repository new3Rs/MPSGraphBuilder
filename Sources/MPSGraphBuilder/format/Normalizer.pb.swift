...
extension CoreML_Specification_Normalizer.NormType: CaseIterable {
  ...
  static let allCases: [CoreML_Specification_Normalizer.NormType] = [
    .lmax,
    .l1,
    .l2,
  ]
...
extension CoreML_Specification_Normalizer: @unchecked Sendable {}
extension CoreML_Specification_Normalizer.NormType: @unchecked Sendable {}
